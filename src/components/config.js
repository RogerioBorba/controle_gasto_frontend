...
export var store = new Vuex.Store({
  ...
  mutations: {
    set_current_component_name(state, a_name) {
      state.current_component_name = a_name;
    },
    set_user(state, a_user) {
      state.user = a_user
    },
    set_token(state, a_token) {
      state.token = a_token
    },
    set_tipo_de_gasto_list(state, list) {
      state.tipo_de_gasto_list = list
    }
  },
  getters: {
    has_token: state => {
